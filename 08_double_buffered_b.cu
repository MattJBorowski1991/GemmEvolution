...
void launch_double_buffered_tc_b(float alpha, const __half* A, const __half* B, float beta, float* C, int M, int K, int N){
...
int main(){
    std::cout << "===08_double_buffered_b (wmma runner)===\n";
    for (int s : TEST_SIZE){
        run_gemm_test_wmma("08_double_buffered_b", launch_double_buffered_tc_b, s, s, s,
...
// nvcc -O3 -arch=sm_86 08_double_buffered_b.cu -o 08_double_buffered_b && ./08_double_buffered_b | tee 08_double_buffered_b.txt